...
namespace Relauncher
{
    class Main
    {
        ...
        private void ProcessXML() 
        {
            ...
            node_list = root.SelectNodes(String.Concat("/relauncher/actions[translate(@stationName, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')='", stationName.ToUpper(), "'and translate(@siteName, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')='", siteName.ToUpper()," ' and string-length(@productName)!=0]"));//aqui se escolhe entre os nós do XML e executa de acorodo com o parametros iniciais.
